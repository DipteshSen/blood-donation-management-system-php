...
<html lang="en">
  ...
  <body>
    ...
    <h3 style="" class="mt-3 mb-3">Donate Blood</h3>
  ...
  <div class="row mb-2">
    <div class="col text-left">
      ...
      <input type="text" name="des" class="form-control" placeholder="Enter Contact No."></input>
    </div>
  </div>
...
if(isset($_POST['submit']))
{
  ...
  $reqdate=$req['a'];
  //echo $reqdate;
  $slq=$conn->query("INSERT INTO donor(userid,username,bg,rh,description,reqdate) values('$userid','$username','$bg','$rh','$des','$reqdate') ;");
  if($slq)
  {
